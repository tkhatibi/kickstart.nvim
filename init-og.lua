...
local function toggle_tokyonight_theme()
...
do
  ...
  -- TODO: Toggle comment
  vim.keymap.set('v', '<C-_>', '', { desc = 'Toggle comment' })
  ...
  -- NOTE: <A-S-l> and <A-S-h> are reserved for terminal tab moves
  ...
  vim.keymap.set('n', '<S-Tab>', '<C-w>W', { desc = 'Go to prev window' })
  ...
  vim.keymap.set('n', '<leader>vn', ':e ~/.config/nvim/NOTES.md<CR>', { desc = 'Open Notes' })

  vim.keymap.set('n', '<leader>vt', ':e ~/.config/nvim/TOOLS.md<CR>', { desc = 'Open Tools' })
  ...
  vim.keymap.set('n', '<leader>ox', ':e .<CR>', { noremap = true, desc = 'File Explorer' })
  ...
  vim.keymap.set('n', '<leader>tt', toggle_tokyonight_theme, { desc = 'Toggle theme' })
...
do
  ...
  -- any other, such as 'tokyonight-storm', 'tokyonight-night', or 'tokyonight-day', or 'unokai'.
  if is_dark_theme then
    vim.cmd.colorscheme 'tokyonight-night'
  else
    vim.cmd.colorscheme 'tokyonight-day'
...
do
  ...
  vim.keymap.set('n', '<leader>oo', builtin.buffers, { desc = 'Find existing buffers' })
  vim.keymap.set('n', '<leader>tT', builtin.colorscheme, { desc = 'Select Theme' })
  ...
  vim.keymap.set(
    ...
    function()
      builtin.live_grep {
        ...
        prompt_title = 'Find By Grep In Buffers',
      }
    end,
    { desc = 'Find By Grep In Buffers' }
  )
